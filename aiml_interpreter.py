...
if __name__ == '__main__':
    ...
    print("Write questions for the chatbot to answer")
...
#-----Notater-----#
"""
Åpne et program/video/bilde
En form for web-searcher
Lage et search query som programmet kan bruke
Stille et spørsmål tilbake, så kan den spørre om man vil ha mer informasjon, deretter åpne en wikipedia side for mer info
